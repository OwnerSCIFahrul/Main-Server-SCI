...
public class GameruleCommand extends CommandBase {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (args.length == 1) {
            switch (args[0]) {
                ...
                case "naturalRegeneration":
                    ...
                    break;
                default:
                    sender.sendMessage(Language.translate("commands.gamerule.unknown", args[0]));
                    return false;
            }
            return true;
        }
            ...
            case "naturalRegeneration":
                switch (args[1]) {
                    ...
                    case "false":
                        ...
                        break;
                    default:
                        sender.sendMessage(Language.translate("commands.generic.invalidboolean", args[1]));
                        return true;
                }
                break;
            default:
        ...
        sender.sendMessage(Language.translate("commands.gamerule.success", new String[]{args[0], value.toString()}));
        return true;
    }
}
