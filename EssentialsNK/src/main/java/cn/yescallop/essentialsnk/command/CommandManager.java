...
public class CommandManager {
    ...
    public static void registerAll(EssentialsAPI api) {
        ...
        map.register("EssentialsNK", new EssentialsNKCommand(api));

        map.register("EssentialsNK", new AntiochCommand(api));
        ...
        map.register("EssentialsNK", new GameruleCommand(api));
        ...
        map.register("EssentialsNK", new NukeCommand(api));
        map.register("EssentialsNK", new WhistleCommand(api));
        ...
        map.register("EssentialsNK", new SpawnAllCommand(api));
        map.register("EssentialsNK", new IgnoreCommand(api));
    }
}