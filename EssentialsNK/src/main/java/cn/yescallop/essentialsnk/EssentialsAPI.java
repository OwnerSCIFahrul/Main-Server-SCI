...
public boolean getPlayerGod(Player player) {
        return this.GodPlayers.contains(player.getName().toLowerCase());
        }

public void setPlayerGod(Player player) {
        this.GodPlayers.add(player.getName().toLowerCase());
        }

public void removePlayerGod(Player player) {
    if (this.GodPlayers.contains(player.getName().toLowerCase())) {
        this.GodPlayers.remove(player.getName().toLowerCase());
    }
