...
import ru.nukkit.multiperms.permissions.Permission;
import ru.nukkit.multiperms.permissions.User;
import ru.nukkit.multiperms.permissions.Users;
import ru.nukkit.multiperms.util.TimeUtil;
...
public class DatabaseSource extends DataProvider {
    ...
    private void prepareQueries() {
        String tablePrefix = MultiPermsPlugin.getCfg().tablePrefix;
    ...
    private TaskHandler runRecheck() {
        Long rescanTime = TimeUtil.parseTime(MultiPermsPlugin.getCfg().multiServerRecheck);
