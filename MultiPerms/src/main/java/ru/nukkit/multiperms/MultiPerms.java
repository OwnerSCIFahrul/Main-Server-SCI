...
import ru.nukkit.multiperms.permissions.*;
...
import static ru.nukkit.multiperms.permissions.Users.getUser;

public class MultiPerms {
    ...
    public static boolean isInGroup(Player player, String group) {
        ...
        try {
            ...
            return MultiPermsPlugin.getCfg().enableWorldSupport ? user.inGroup(player.getLevel().getName(), group) : false;
        } catch (Exception ignore) {
            //
        }
        return false;
