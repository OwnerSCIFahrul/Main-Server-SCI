...
public class EconomyAPI extends PluginBase implements Listener{
	...
	public String getMessage(String key, String[] params, String player){ // TODO: Individual language
		...
		return "Tidak ada pesan dengan kunci \"" + key + "\"";
	}
	...
	private void registerCommands(){
		this.getServer().getCommandMap().register("mycoin", new MyMoneyCommand(this));
		this.getServer().getCommandMap().register("topcoin", new TopMoneyCommand(this));
		this.getServer().getCommandMap().register("seecoin", new SeeMoneyCommand(this));
		this.getServer().getCommandMap().register("givecoin", new GiveMoneyCommand(this));
		this.getServer().getCommandMap().register("takecoin", new TakeMoneyCommand(this));
		this.getServer().getCommandMap().register("paycoin", new PayCommand(this));
		this.getServer().getCommandMap().register("setcoin", new SetMoneyCommand(this));
		this.getServer().getCommandMap().register("setlang", new SetLangCommand(this));
	}
	...
	private boolean selectProvider(){
		...
		if(providerClass == null){
			this.getLogger().critical("Penyedia data tidak valid diberikan.");
			return false;
		}
		...
		this.getLogger().notice("Penyedia data diatur ke: "+provider.getName());
		return true;
	}
