...
public class Server implements IServer {
    ...
    private int index = 0;
    private static final Timer timer = new Timer("Waktu ServerMusic", true);
    ...
    public synchronized void next(boolean force) {
        ...
        switch (this.mode) {
            case MODE_RANDOM:
                this.index = ServerMusicPlugin.getRNG().nextInt(this.playlist.size());
                break;
            case MODE_ORDER:
            default:
    ...
    public String toString() {
        return "ServerMusic(" + this.playlist + ")";
    }
    ...
    public static void play(IMusic music, Player... players) {
        ...
        Preconditions.checkNotNull(music, "songs");

        String message = TextFormat.YELLOW + "Sedang Dimainkan: " + TextFormat.BOLD + music.getName();
