...
@CmdDefine(command = "chat", alias = "multichat", subCommands = {"set", "chat|name|tag|nametag"}, permission = "multichat.config.chatset", description = Message.CHAT_SET, allowConsole = true)
